...
def process_files(
    ...
    if num_files_needed == 2:
        lower_file = look_up_file(
            math.ceil(lower_lat),
            math.ceil(lower_long),
            lower_lat,
            lower_long,
        ...
        bottom_right_file = look_up_file(
            math.ceil(lower_lat),
            math.ceil(lower_long),
            lower_lat,
            lower_long,
        ...
        top_right_file = look_up_file(
            math.ceil(lower_lat),
            math.ceil(upper_long),
            lower_lat,
            lower_long,
            base_dir=volume_directory,
        )
    ...
    translate_options = gdal.TranslateOptions(
        projWin=[upper_long, upper_lat, lower_long, lower_lat]
    )
